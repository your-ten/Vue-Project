<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
      <a class="back">
        <i class="iconfont icon-arrow_left" @click="$router.replace('/msite')"/>
      </a>
    </nav>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowDis=true">
      <div class="discounts-left">
        <div class="activity" :class="activeClass[info.supports[0].type]">
          <span class="content-tag">
    ...
    <div class="activity-sheet" v-show="isShowDis">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
        优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="activeClass[support.type]" v-for="(support, index) in info.supports" :key="index">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="isShowDis=false"></span>
        </div>
      </div>
      <div class="activity-sheet-cover" @click="isShowDis=false"></div>
    </div>
  </div>
</template>
