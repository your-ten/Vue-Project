    ...
    <div class="shopcart">
      <div class="content">
        <div class="content-left" @click="toggleShow">
          ...
          <div class="price" :class="{highlight:totalCount>0}">￥{{totalMoney}}</div>
...
<script type="text/ecmascript-6">
  ...
  import {CLEAR_CART} from '@/vuex/mutations_type'
  export default {
    data(){
      return {
        isShow:false
    ...
    computed:{
      ...
      payClass(){
        ...
        return totalMoney >= info.minPrice ? 'enough' : 'not-enough'
      },
      payText(){
    ...
    methods:{
      ...
      clearCart(){
        ...
        .then(()=>{this.$store.commit(CLEAR_CART)})
      }
    }
  }
</script>
